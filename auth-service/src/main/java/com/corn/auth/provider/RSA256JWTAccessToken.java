package com.corn.auth.provider;

import com.corn.security.oauth.JWTAccessToken;
...
public class RSA256JWTAccessToken extends JWTAccessToken {
    ...
    RSA256JWTAccessToken(UserDetailsService userDetailsService) {
        ...
        KeyStoreKeyFactory keyStoreKeyFactory = new KeyStoreKeyFactory(new ClassPathResource("corn-jwt.jks"), "corn123".toCharArray());
        setKeyPair(keyStoreKeyFactory.getKeyPair("corn-jwt"));
    }
    ...
    protected String encode(OAuth2AccessToken accessToken, OAuth2Authentication authentication) {
        ...
        Map<String, String> headers = Collections.singletonMap("kid", "msistio-jwt-kid");
